...
-->
			<li role=""presentation"" class=""active"">
				<a href=""#minute"" aria-controls=""minute"" role=""tab"" data-toggle=""tab"">Minute</a>
			</li>
			<li role=""presentation"">
				<a href=""#hour"" aria-controls=""hour"" role=""tab"" data-toggle=""tab"">Hour</a>
			</li>
			<li role=""presentation"">
...
-->
			<li role=""presentation"">
				<a href=""#general"" aria-controls=""general"" role=""tab"" data-toggle=""tab"">Common Cron Expressions</a>
			</li>
			<li role=""presentation"">
				<a href=""#cron"" aria-controls=""cron"" role=""tab"" data-toggle=""tab"">Cron Expression Analysis</a>
			</li>
		</ul>
		<!-- Tab panes -->
				...
				<div class=""form-group"">
					<div class=""input-group input-group-sm"">
						...
						<div class=""input-group-btn "">
							<button type=""button"" id=""analysis"" class=""btn btn-default""><span class=""glyphicon glyphicon-ok""></span>  &nbsp;Analysis</button>
						</div>
					</div>
				</div>
			</form>
